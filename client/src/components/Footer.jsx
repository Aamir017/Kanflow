    ...
    <footer className="footer">
      <div className="footer-content">
        <div className="footer-section">
          <h3 className="footer-title">Kanflow</h3>
        ...
        <div className="footer-section">
          ...
          <div className="social-links">
            {/* 
              TODO: Replace these placeholder links with your actual profiles
            ...
            */}
            <a 
              href="https://linkedin.com/in/skaamir10" 
              target="_blank" 
            ...
            <a 
              href="https://github.com/Aamir017" 
              target="_blank" 
              rel="noopener noreferrer"
            ...
            <a 
              href="mailto:aamir.sk.dev@gmail.com" 
      ...
      <div className="footer-bottom">
        <div className="footer-bottom-content">
          <p>&copy; Kanflow. Built with ❤️ using React, Node.js, Express & MongoDB.</p>
          <p className="tech-stack">React • Node.js • Express • MongoDB • JWT Authentication</p>
        </div>
      </div>
    </footer>
  );
